class ExportMultiplesHeaderWorker
  ...
  def perform(primary_reference, respondent_name, case_references, case_type_id, export_id, send_request_id)
    created_case = service.export_header(primary_reference, respondent_name, case_references, case_type_id, export_id, sidekiq_job_data: job_hash, send_request_id: send_request_id)
