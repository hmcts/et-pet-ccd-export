module EtCcdExport
  class ExportMultipleClaimsService # rubocop:disable Metrics/ClassLength
    ...
    def initialize(client_class: EtCcdClient::Client, # rubocop:disable Metrics/ParameterLists
      ...
      worker: EtCcdExport::ExportMultiplesJob,
      header_worker: EtCcdExport::ExportMultiplesHeaderJob)
    ...
    def fetch_existing_case_as_exported(client, reference, case_type_id:, extra_headers:)
      client.caseworker_search_latest_by_ethos_case_reference(reference, case_type_id: case_type_id, extra_headers: extra_headers)
    end
